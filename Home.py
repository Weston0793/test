...
def main():
    ...
    if uploaded_file:
        ...
        if main_region == "Felső végtag":
            sub_region = st.selectbox("Alrégió", ["Váll", "Kar", "Könyök", "Alkar", "Csukló", "Kéz"])
            ...
            sub_region = st.selectbox("Alrégió", ["Medence", "Sacralis", "Coccygealis", "Csípő", "Femur", "Térd", "Lábszár", "Boka", "Láb"])
            ...
            sub_region = st.selectbox("Alrégió", ["Borda", "Sternum", "Tüdő", "Szív"])
        
        elif main_region == "Has":
            sub_region = st.selectbox("Alrégió", ["Máj", "Lép", "Vese", "Bél", "Hólyag"])
