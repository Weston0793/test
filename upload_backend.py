...
def confirm_and_upload_data(upload_data):
    ...
    for idx, region in enumerate(upload_data["regions"]):
        st.markdown(f"<div class='content'><strong><span class='highlight'>Régió {idx + 1}:</span></strong></div>", unsafe_allow_html=True)
        if region['main_region']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Fő régió:</span></strong> {region['main_region']}</div>", unsafe_allow_html=True)
        if region['side']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Oldal:</span></strong> {region['side']}</div>", unsafe_allow_html=True)
        if region['sub_region']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Alrégió:</span></strong> {region['sub_region']}</div>", unsafe_allow_html=True)
        if region['sub_sub_region']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Részletes régió:</span></strong> {region['sub_sub_region']}</div>", unsafe_allow_html=True)
        if region['sub_sub_sub_region']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Legpontosabb régió:</span></strong> {region['sub_sub_sub_region']}</div>", unsafe_allow_html=True)
        if region['finger']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Ujj:</span></strong> {region['finger']}</div>", unsafe_allow_html=True)
        if region['sub_sub_sub_sub_region']:
            st.markdown(f"<div class='content'><strong><span class='highlight'>Legrészletesebb régió:</span></strong> {region['sub_sub_sub_sub_region']}</div>", unsafe_allow_html=True)
        ...
        if region.get("classification"):
            for classification_name, details in region["classification"].items():
                if "name" in details and "severity" in details:
                    st.markdown(f"<div class='content'><strong><span class='highlight'>Osztályozás:</span></strong> {details['name']}</div>", unsafe_allow_html=True)
                    st.markdown(f"<div class='content'><strong><span class='highlight'>Súlyosság:</span></strong> {details['severity']}</div>", unsafe_allow_html=True)
                    if "subseverity" in details:
                        st.markdown(f"<div class='content'><strong><span class='highlight'>Alsúlyosság:</span></strong> {details['subseverity']}</div>", unsafe_allow_html=True)
